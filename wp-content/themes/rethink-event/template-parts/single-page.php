        ...
        <div class="pg-single__top__right">
          ...
          <div class="pg-single__socials">
            <?php if ($website) : ?>
              ...
              <a class="pg-single__social" href="<?php echo $website ?>" target="_blank" rel="noopener noreferrer">
            ...
            <?php if ($linkedin) : ?>
              ...
              <a class="pg-single__social" href="<?php echo $linkedin; ?>" target="_blank" rel="noopener noreferrer">
            ...
            <?php if ($facebook) : ?>
              ...
              <a class="pg-single__social" href="<?php echo $facebook; ?>" target="_blank" rel="noopener noreferrer">
            ...
            <?php if ($twitter) : ?>
              ...
              <a class="pg-single__social" href="<?php echo $twitter; ?>" target="_blank" rel="noopener noreferrer">
            ...
            <?php if ($instagram) : ?>
              ...
              <a class="pg-single__social" href="<?php echo $instagram; ?>" target="_blank" rel="noopener noreferrer">
