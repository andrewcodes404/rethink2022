...
function modula_pro_output_filters( $settings ) {
	...
	$filter_by_text = '';
	if ( isset( $settings['enableCollapsibleFilters'] ) && '1' == $settings['enableCollapsibleFilters'] && isset( $settings['collapsibleActionText'] ) && ( !isset( $settings['dropdownFilters'] ) || '1' != $settings['dropdownFilters'] ) && ( !isset( $settings['enableMobileDropdownFilters'] ) || '1' != $settings['enableMobileDropdownFilters'] ) ){
		$filter_by_text = $settings['collapsibleActionText'];
	}

	$filter_by_wrapper_style = '';
	if ( isset( $settings['enableCollapsibleFilters'] ) && '1' == $settings['enableCollapsibleFilters'] && ( !isset( $settings['dropdownFilters'] ) || '1' != $settings['dropdownFilters'] ) && ( !isset( $settings['enableMobileDropdownFilters'] ) || '1' != $settings['enableMobileDropdownFilters'] ) ){
